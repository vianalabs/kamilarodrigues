...
class AdminTestCase(StaticLiveServerTestCase):
    ...
    def test_positive_login_into_admin_page(self):
        ...
        login = self.fx_driver.find_element(
            By.CSS_SELECTOR, ".submit-row input"
        )
        login.click()
        time.sleep(2)
    ...
    def test_positive_create_category_and_post(self):
        ...
        LOCALHOST_ADD_CATEGORY = (
            f"{self.live_server_url}/admin/app/category/add/"
        )
        ...
        categories = Select(
            self.fx_driver.find_element(By.ID, "id_categories")
        )
